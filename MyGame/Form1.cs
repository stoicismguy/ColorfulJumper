...
namespace MyGame
{
    public partial class Form1 : Form
    {
        ...
        private void OnPaint(object sender, PaintEventArgs e)
        {
            ...
            foreach (var particle in player.particles)
            {
                graphics.DrawImage(particle.particleImg, particle.X, particle.Y, particle.particleImg.Width, particle.particleImg.Height);
            }
